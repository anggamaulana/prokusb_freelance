...
<p>
  <?php
			$q="select t.id_transaksi,t.waktu as Waktu,p.paket as Paket,t.faktur as Faktur,per.nama_perusahaan as Perusahaan,per.email as Email,t.waktu_mulai as Mulai,t.waktu_selesai as Deadline from transaksi t, paket p, perusahaan per where t.id_perusahaan=per.id_perusahaan and t.id_paket=p.id_paket and t.status_konfirm='W'";
...
<table width="893">
  ...
  <tr>
		...
		?></td>
		<td>
			<a href="<?php echo "formtransaksipembayaran.php?i=".$r->id_transaksi;?>">Konfirmasi</a>
		</td>
  </tr>
  </tr>
  <?php
