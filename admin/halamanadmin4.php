...
<p>
  <?php
			$q="select t.id_transaksi,t.waktu as Waktu,p.paket as Paket,t.faktur as Faktur,per.nama_perusahaan as Perusahaan,per.email as Email,t.waktu_mulai as Mulai,t.waktu_selesai as Deadline,t.status_konfirm as Status from transaksi t, paket p, perusahaan per where t.id_perusahaan=per.id_perusahaan and t.id_paket=p.id_paket and (t.status_konfirm='C' or t.status_konfirm='E')";
